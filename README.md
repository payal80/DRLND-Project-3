...
The main file of this project is `Tennis.ipynb`. To use a Jupyter notebook, run the following command from the `p3_collab-compet/` folder:
```
jupyter notebook
```
and open `Tennis.ipynb` from the list of files.  Alternatively, you may prefer to work with the [JupyterLab](https://jupyterlab.readthedocs.io/en/latest/) interface.  To do this, run this command instead:
```
jupyter-lab
```
